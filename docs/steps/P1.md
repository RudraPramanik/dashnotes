...
**Use this file only** while building Phase 1. Requires Phase 0 complete. Attach `@docs/steps/P1.md` and `@docs/dev_progress.md` in Cursor sessions.

| Also read if stuck | Doc |
|--------------------|-----|
| Auth contract | `docs/backend-frontend-contract.md` § P0 Auth |
